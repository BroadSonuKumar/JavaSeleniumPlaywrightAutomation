...
public class TestSliders {
    public static void main(String[] args) {
        ...
        Locator slider = page.locator("//div[@id='slider']/span");
        ...
        page.mouse().up();
        page.screenshot(new Page.ScreenshotOptions().setPath(Paths.get("src/test/resources/screanshot/screanshot.png")));
        playwright.close();
    }
}
