...
public class TestAssertions {
    ...
    public static void main(String[] args) {
        ...
        assertThat(page.locator("//html/body/table[3]/tbody/tr[1]/td[2]/table/tbody/tr/td/div[7]/input[1]")).isChecked();
        assertThat(page.locator("//html/body/table[3]/tbody/tr[1]/td[2]/table/tbody/tr/td/div[7]/input[2]")).isVisible();
